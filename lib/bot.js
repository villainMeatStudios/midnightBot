...
class Bot {
    ...
    static checkMessage(message) {
        ...
        const botRegex1 = /midnight/;
        const botRegex2 = /Midnight/;
        const botRegex3 = /bud\slight/;
        const botRegex4 = /housekeeping/;
        // Check if the GroupMe message has content and if the regex pattern is true
        if (messageText && (botRegex1.test(messageText) || botRegex2.test(messageText) || botRegex3.test(messageText) || botRegex4.test(messageText))) {
